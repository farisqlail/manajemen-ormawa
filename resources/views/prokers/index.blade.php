        ...
        <div class="col-md-3 mb-4">
            <div class="card" style="width: auto; display: inline-block;">
                <div class="card-body">
                    ...
                    <p class="card-text"><strong>Status:</strong> <span class="badge badge-warning">{{ $proker->status }}</span></p>
                    ...
                    <div class="d-flex">
                        ...
                        <a href="{{ route('prokers.export', $proker->id) }}" class="btn btn-primary mr-2">
                            Proposal
                        </a>
